...
**Praktyczna zasada:** Zamiast dawać agentowi wszystkie PLAN\_\*.md naraz (przepełnienie kontekstu), używaj RAG żeby wyciągać tylko relevantne sekcje. To szczególnie ważne przy projektach z 5+ plikami PLAN.
...
_Dokument jest żywy — aktualizuj go gdy workflow ewoluuje._
_Wersja tego pliku też powinna mieć historię zmian na dole._
